...
import {COLLAPSE_TOGGLE,NAV_COLLAPSE_LEAVE} from "../../../../../../store/reduceSlice";
...
class NavCollapse extends Component {
    ...
    render() {
        ...
        const subContent = (
            <Aux>
                <a href={DEMO.BLANK_LINK}  className={navLinkClass.join(' ')} onClick={(e) => {
                    this.props.onCollapseToggle(this.props.collapse.id, this.props.type)
                    e.preventDefault()
                }}>
...
const mapStateToProps = state => {
    return {
        ...
        isOpen: state.reducerSlice.isOpen,
        isTrigger: state.reducerSlice.isTrigger
    }
};

const mapDispatchToProps = dispatch => {
    return {
        onCollapseToggle: (id, type) => dispatch({type: COLLAPSE_TOGGLE, menu: {id: id, type: type}}),
        onNavCollapseLeave: (id, type) => dispatch({type: NAV_COLLAPSE_LEAVE, menu: {id: id, type: type}})
    }
};
